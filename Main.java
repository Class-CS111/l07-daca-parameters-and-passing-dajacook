...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        surname = UtilityBelt.readString("Enter surname: ", 0, 100);
        givenName = UtilityBelt.readString("Enter your given name: ", 0, 100);
        category = UtilityBelt.readString("Enter category: ", 0, 3);
        cardNum = UtilityBelt.readString("Enter card number: ", 0, 13);
        birthCountry = UtilityBelt.readString("Enter birth country: ", 0, 100);
        termsAndConditions = UtilityBelt.readString("Enter terms and conditions: ", 0, 100);
        ...
        birthMonth = UtilityBelt.readString("Enter birth month (as a 3-letter acronym in ALl CAPS): ", 3, 3);
        ...
        validYear = UtilityBelt.readInt("Enter valid year: ", 1700, 2030);

        expireMonth = UtilityBelt.readInt("Enter expiration month: ", 1, 12);
        expireDay = UtilityBelt.readInt("Enter expiration day: ", 1, 31);
        expireYear = UtilityBelt.readInt("Enter expiration year: ", 1700, 2030);
